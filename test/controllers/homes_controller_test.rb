...
class HomesControllerTest < ActionController::TestCase
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post :create, home: { description: @home.description, name: @home.name, picture: @home.picture, sdt: @home.sdt }
    end
  ...
  test "should update home" do
    patch :update, id: @home, home: { description: @home.description, name: @home.name, picture: @home.picture, sdt: @home.sdt }
    assert_redirected_to home_path(assigns(:home))
  end
